...
public class EmpleadoControlador {
    ...
    public String registrarEmpleado(@RequestParam String fechaIngreso,@ModelAttribute Empleado empleado) {
        ...
        empleado.setFechaIngreso(LocalDate.parse(fechaIngreso, formatter)); // Aquí se puede ajustar según tu lógica
